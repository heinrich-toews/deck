OC.L10N.register(
    "deck",
    {
    "Apply default view {name}" : "Standardansicht {name} anwenden",
    "Apply view {name}" : "Ansicht {name} anwenden",
    "Default" : "Standard",
    "Default view for all boards" : "Standardansicht für alle Boards",
    "Delete view {name}" : "Ansicht {name} löschen",
    "Name for the saved view" : "Name für die gespeicherte Ansicht",
    "Remove default view" : "Standardansicht entfernen",
    "Save view" : "Ansicht speichern",
    "Saved views" : "Gespeicherte Ansichten",
    "The selected view is applied automatically when you open any board." : "Die ausgewählte Ansicht wird automatisch angewendet, wenn Sie ein Board öffnen.",
    ...
    "The remote board %1$s has been shared with you by %2$s" : "Das Remote-Board %1$s wurde von %2$s mit Ihnen geteilt",
    ...
    "All boards owned by you including stacks, cards, labels, assignments, and comments" : "Alle Boards, die Ihnen gehören, einschließlich Stapeln, Karten, Etiketten, Zuordnungen und Kommentaren",
    ...
    "Supported prefixes: {prefixes}. Wrap phrases in double quotes." : "Unterstützte Präfixe: {prefixes}. Phrasen in doppelte Anführungszeichen setzen.",
    ...
    "Weeks" : "Wochen",
    "Months" : "Monate",
    "No cards yet" : "Bislang keine Karten",
    "Set a start date and due date on your cards to see them on the Gantt chart" : "Ein Start- und Zieldatum auf Ihren Karten setzen, um dieses in der Gantt-Ansicht zu anzuzeigen",
    "Cards without dates ({count})" : "Karten ohne Datum ({count})",
    "Failed to create share with {displayName}" : "Freigabe mit dem Namen {displayName} konnte nicht erstellt werden",
    "Are you sure you want to transfer the board {title} to {user}?" : "Möchten Sie das Board {title} auf {user} übertragen?",
    ...
    "Modified: {modifiedDate} ⸱ Created: {createdDate}" : "Geändert: {modifiedDate} ⸱ Erstellt: {createdDate}",
    "Modified: {modifiedDate}\nCreated: {createdDate}\nCreated by: {owner}" : "Geändert: {modifiedDate}\nErstellt: {createdDate}\nErstellt von: {owner}",
    "Modified: {modifiedDate}\nCreated: {createdDate}" : "Geändert: {modifiedDate}\nErstellt: {createdDate}",
    ...
    "Assign dependent cards" : "Abhängige Karten zuweisen",
    "Mark as done" : "Als erledigt markieren",
    "Mark as not done" : "Als unerledigt markieren",
    "Remove dependency" : "Abhängigkeit entfernen",
    "Add dependent card" : "Abhängige Karte hinzufügen",
    "Assign a dependent card…" : "Eine abhängige Karte zuweisen …",
    "Select a dependent card…" : "Eine abhängige Karte auswählen …",
    ...
    "Are you sure you want to delete the board {title}? This will delete all the data of this board including archived cards." : "Möchten Sie das Board {title} löschen? Dadurch werden alle Daten dieses Boards einschließlich archivierter Karten gelöscht.",
    "Delete the board?" : "Das Board löschen?",
    "Are you sure you want to leave the board {title}?" : "Möchten Sie das Board {title} verlassen?",
